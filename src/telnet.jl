...
A shortcut to connect to JPL HORIZONS telnet interface

`telnet horizons.jpl.nasa.gov 6775`

"""
function horizons()
    run(`telnet horizons.jpl.nasa.gov 6775`)
end
